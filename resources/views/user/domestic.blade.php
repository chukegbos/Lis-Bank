...
@section('pageTitle', 'Domestic Transactions')
@section('content')
<div class="breadcromb-area">
   <div class="row">
        <div class="col-md-6  col-sm-6">
            <div class="seipkon-breadcromb-left pt-3  pull-right text-center">
                <h3>Domestic Transactions</h3>
                <br>
                <a href="#page-box" class="btn btn-excel pull-right">View Domestic Transactions</a> 
            </div>
        </div>
   </div>
</div>
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card ">
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ url('user/domestic-transfer') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="your-label" class="form-label">Reciever's Account Number</label>
                                    <input type="text" name="rec_number" required="" class="form-control"  id="rec_number" onkeyup="myFunction()">
                                </div>
                                <div id="wrapper"></div>
                            </div> 
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" required class="form-control" name="amount" max="{{ Auth::user()->balance }}">
                                </div>
                            </div>
