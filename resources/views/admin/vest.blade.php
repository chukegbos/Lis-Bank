                    ...
                    <tbody>
                      @forelse($withdraws as $withdraw)
                        <tr>
                          ...
                          <td>
                            {{ \Carbon\Carbon::createFromTimeStamp(strtotime($withdraw->due_date))->toFormattedDateString() }} 
                          </td>
                          <td>{{ $withdraw->purpose }}</td>
                          <td>
                            @if($withdraw->due_date < \Carbon\Carbon::today())
                              Completed
                            @else
                              Running
                            @endif
