              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="addCourseLabel">Add Loan Price</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>

                  <form method="POST" action="{{ url('admin/loan-plan') }}" enctype="multipart/form-data">
                    @csrf
                ...
                @forelse($prices as $price)
                  <tr>
                    ...
                    <td>
                      ...
                      <form id="delete{{ $price->id }}" action="{{ url('admin/loan-plan') }}/{{ $price->id }}" method="POST" style="display: none;">
                        {{ csrf_field() }}
                        {{ Method_field('DELETE') }}
                      </form>  
                    </td>
                  ...
                  <div class="modal fade mt-5" id="editSession{{ $price->id }}" tabindex="-1" role="dialog" aria-labelledby="editSession{{ $price->id }}Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <form method="POST" action="{{ url('admin/loan-plan') }}/{{ $price->id }}">
                          @csrf
                          {{ method_field('PUT') }}
                          <div class="modal-body">
                            <div class="form-group">
